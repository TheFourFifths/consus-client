...
import DelinquentReportController from '../../../../.dist/controllers/pages/students';

describe("DelinquentReportController", () => {
    let dispatcherSpy;
    beforeEach(() => {
    ...
    describe("getStudents",() => {
        ...
        it("Gets all students", () => {
            ...
            return DelinquentReportController.getStudents().then(() => {
