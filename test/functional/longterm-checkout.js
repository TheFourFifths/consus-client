...
describe('Checking an item out longterm', function () {
    ...
    it('changes existing checkout to longterm', () => {
        ...
        return app.client.waitForVisible('.cart input[type="text"]').then(() => {
            ...
            return app.client.click('#student .student .equipment .item-info .longtermDateInput')
        }).then(() => {
            return app.client.waitForVisible('#app .modal .modal-content input[type="date"]');
        }).then(() => {
            return app.client.click('#app .modal .modal-content input[type="date"]');
        }).then(() => {
            return app.client.keys('06062020');
        }).then(() => {
            return app.client.click('#app .modal .modal-content #modalConfirm');
        }).then(() => {
            mockServer.validate();
        });
    });
